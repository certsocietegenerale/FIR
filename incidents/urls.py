...
urlpatterns = patterns('',
    ...
    url(r'^(?P<incident_id>\d+)/upload/$', views.upload_file, name='upload_file'),
    ...
    url(r'^(?P<incident_id>\d+)/download/(?P<filename>.+)$', views.download, name='download'),
    url(r'^(?P<incident_id>\d+)/download/$', views.download_archive, name='download_archive'),
    url(r'^(?P<incident_id>\d+)/remove/(?P<file_id>\d+)$', views.remove_file, name='remove_file'),
